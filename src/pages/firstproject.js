...
import imageUrl from '../assests/project1.png'
...
import CoverImage from '../assests/project1Cover.png';
import CoverImage2 from '../assests/project1Cover2.png';
      ...
      <Box sx={{ backgroundColor: '#171716', color: '#fff', textAlign: 'center' }}>
        ...
        <Grid container alignItems={'center'} >
          ...
          <Grid item lg={6} md={12} mb={4} sx={{ p: " 0px 10px !important" }}>
            ...
            >
              This case study details the redesign of the Job Match Score Progress Page for JobQuest.ai, a platform dedicated to supporting job seekers in their quest for employment. By leveraging artificial intelligence, JobQuest.ai analyzes users' resumes against job descriptions, generating a personalized Job Match Score to help improve the alignment of applicants' profiles with job requirements.
            </Typography>
          </Grid>
      ...
      <Grid container xs={12} sx={{ margin: '0 auto', mb: 5, position: 'relative' }} alignItems={'flex-start'} justifyContent={'flex-start'} p={5} >
        <Grid item lg={7} md={7} sm={11} xs={11} mb={6} >
          ...
          <Typography variant="body1" sx={{
            ...
            The original Job Match Score Progress Page presented several challenges: it was
            cluttered with excessive information, which overwhelmed users and hindered their
            understanding of the score generation process. Additionally, the page was not
            optimized for mobile devices, leading to a frustrating experience for users accessing
            the platform on smartphones or tablets.
          </Typography>
        </Grid>
        ...
        <Grid container gap={3}>
          <Grid item lg={5} md={5} sm={12} xs={12} sx={{ fontFamily: 'Inter', fontWeight: 700, backgroundColor: '#F8F7F6', p: 4, borderRadius: "12px" }}>
            ...
            <Typography variant="body1" sx={{
              ...
              <ul>
                <li>Simplify the Progress Page for clarity.</li>
                <li>Enhance mobile usability for a seamless experience.</li>
                <li>Improve user understanding of the Job Match Score.</li>
              </ul>
            </Typography>
          </Grid>
          <Grid item lg={5} md={5} sm={12} xs={12} sx={{ fontFamily: 'Inter', fontWeight: 700, backgroundColor: '#F8F7F6', p: 4, borderRadius: "12px" }}>
            ...
            <Typography variant="body1" sx={{
              ...
              <ul>
                <li>Reducing clutter while retaining essential details.</li>
                <li>Ensuring seamless adaptation across devices.</li>
                <li>Integrating diverse user feedback effectively.</li>
              </ul>
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container gap={3}>
          <Grid item lg={5} md={5} sm={12} xs={12} sx={{ fontFamily: 'Inter', fontWeight: 700, backgroundColor: '#F8F7F6', p: 4, borderRadius: "12px" }}>
            ...
            <Typography variant="body1" sx={{
              ...
              <ul>
                <li>Redesigned layout to simplify design and highlight key information.</li>
                <li>Developed a mobile-first responsive design.</li>
                <li>Continuously integrated user feedback for refinement.</li>
              </ul>
            </Typography>
          </Grid>
          <Grid item lg={5} md={5} sm={12} xs={12} sx={{ fontFamily: 'Inter', fontWeight: 700, backgroundColor: '#F8F7F6', p: 4, borderRadius: "12px" }}>
            ...
            <Typography variant="body1" sx={{
              ...
              <ul>
                <li>Achieved a cleaner, more focused layout.</li>
                <li>Increased mobile usage, reflecting better accessibility.</li>
                <li>Received favorable responses regarding usability and clarity.</li>
              </ul>
            </Typography>
          </Grid>
        </Grid>
