...
const Portfolio = () => {
    ...
    const cardData = [
        {
            id: 2,
            title: 'Case Study - AI Customize Resume & Skill Approval',
       ...
       
        {
            ...
            description: 'This is a description for card 1.',
            image: scalekit,
            url: 'https://www.figma.com/design/uSsgy9bywSWz3WCJAFRJF6/ScaleKit-by-Wajiha-Fatima?node-id=322-15822&t=H35fr6fRIuDandZC-1'
        },
        {
            id: 2,
            title: 'JobQuest.ai',
